...
void MakeChargeFullComparison()
{
  ...
  //   g  ==> charge
  //   pi ==> full 
  TFile *fOut = new TFile("dataCompG.r03a02rm1.d20m1y2017.root", "recreate");
  f_g= new TFile("data/pp200corr.r03rm1chrg.d16m1y2017.differentPlots.root");
  f_pi= new TFile("data/pp200corr.r03rm1full.d16m1y2017.differentPlots.root");
  ...
  h_Datajet_JetPtCorr_pi0 = (TH1F*)*f_pi->Get("Gam/hJetPtCorrG");

  TH1F *h_pi0 =h_Datajet_JetPtCorr_pi0;
  TH1F *h_g =h_Datajet_JetPtCorr_g;
  TString nameStatus = "#gamma_{rich} trigger";
  Double_t Y_max= 1.52;
  ...
  //   c->Range(-7.241379,-2.096007,5.249042,2.699528);
   ...
   Draw_hist(h_g, "PSAME", 2, 2, 20, 1.1 );
   //   Draw_hist(h_pi0, "PSAME", kGreen+4,kGreen+4, 29, 1.6 );
   Draw_hist(h_pi0, "PSAME", 2, 2, 24, 1.1 );
    ...
    Draw_Legend(leg2, 0.54,0.73,0.66,0.97,"p+p 200 GeV",JetRecoLegnd.Data(),"9 < p_{T}^{trig} < 20 GeV/c",nameStatus.Data(),""  );
