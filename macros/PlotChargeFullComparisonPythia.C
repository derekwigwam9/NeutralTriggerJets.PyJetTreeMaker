...
void PlotChargeFullComparisonPythia()
{
  ...
  TFile *fOut = new TFile("pythiaCompD.r05a065rm1.d23m1y2017.root", "recreate");
  f_g= new TFile("pythiaCompGD.r05a065rm1.d23m1y2017.root");
  f_pi= new TFile("pythiaCompP.r05a065rm1.d23m1y2017.root");
...
*/
  ...
  //   c->Range(-7.241379,-2.096007,5.249042,2.699528);
   ...
   Draw_hist(h_pi0F, "PSAME", 4, 4, 30, 1.6 );
    ...
    leg->SetLineColor(0);
    leg->AddEntry(h_gC,"#gamma_{dir}-jet [Charged]","p");
    leg->AddEntry(h_gF,"#gamma_{dir}-jet [Full]","p");
...
*/
   ...
   leg = new TLegend(0.64,0.60,0.86,0.70);
    ...
    leg->SetLineColor(0);
    leg->AddEntry(h_RatioG, "#gamma_{dir}", "p");
    leg->AddEntry(h_RatioP, "#pi^{0}", "p");
