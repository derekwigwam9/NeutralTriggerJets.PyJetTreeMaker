...
void MakePythiaPlots()
{
 

 
  TFile *fOut = new TFile("pythiaCheckR.p40.r03a02rm1full.d28m1y2017.root", "recreate");
  f_g= new TFile("../JetMacro/pythiaCheckR.r03a02rm1full.d28m1y2017.root");
  f_pi= new TFile("../JetMacro/pythiaCheckR.r03a02rm1full.d28m1y2017.root");
  ...
  //   c->Range(-7.241379,-2.096007,5.249042,2.699528);
   ...
   //____Y-axis
   h1->GetYaxis()->SetTitle("1/N_{trig} dN_{jets}/(dp_{T,jet}^{par} d#eta_{jet})");
   ...
   Draw_hist(h_pi0, "PSAME", 4, 4, 30, 1.6 );
    ...
    leg->SetLineColor(0);
    leg->AddEntry(h_g,"Trigger-#gamma_{rich}(40\045 purity)","p");
    leg->AddEntry(h_pi0,"Trigger-#pi^{0}","p");
...
// ------------>Primitives in pad: pad2
   ...
   //_____X-axis
   h3->GetXaxis()->SetTitle("p_{T,jet}^{par} [GeV/c]");
