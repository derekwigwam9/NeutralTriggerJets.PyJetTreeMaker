...
void MakeChargeFullComparisonPythia()
{
  ...
  //   g  ==> charge
  //   pi ==> full 
  TFile *fOut = new TFile("pythiaCompP.r05a065rm1.d23m1y2017.root", "recreate");
  f_g= new TFile("pythia/pythia.r05a065rm1chrg.d19m1y2017.plots.root");
  f_pi= new TFile("pythia/pythia.r05a065rm1full.d19m1y2017.plots.root");
  ...
  h_Datajet_JetPtCorr_g = (TH1F*)*f_g->Get("hPi0");
  ...
  //   c->Range(-7.241379,-2.096007,5.249042,2.699528);
   ...
   Draw_hist(h_pi0, "PSAME", 2, 2, 24, 1.1 );
    ...
    Draw_Legend(leg2, 0.54,0.73,0.66,0.97,"Pythia: p+p 200 GeV",JetRecoLegnd.Data(),"9 < p_{T}^{trig} < 20 GeV/c",nameStatus.Data(),"");
